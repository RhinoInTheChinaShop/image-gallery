...
CREATE TABLE events (id INTEGER PRIMARY KEY, name, dateStart, dateEnd, allowedAccountTypes, password, people, thumbnailDay, thumbnailURL, location, tags, days);
CREATE TABLE days (globalId INTEGER PRIMARY KEY, eventId, name, date, people, thumbnailShot, thubnailURL, event, shots, location, tags);
CREATE TABLE shots (globalId INTEGER PRIMARY KEY, eventId, shortDescription, longDescription, thumbnailPhoto, thumbnailURL, people, photos, day, location, tags);
CREATE TABLE photos (globalId INTEGER PRIMARY KEY, eventId, fullsizedURL, smallURL, thumbnailURL, shortDescription, longDescription, user, shot, location, tags, people);
